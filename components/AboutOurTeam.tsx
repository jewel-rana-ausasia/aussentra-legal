...
const AboutOurTeam = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-background via-background to-secondary py-24 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-20">
          ...
          <h2 className="text-5xl md:text-6xl font-serif font-bold text-foreground mb-6 text-balance">
              ...
              <div className="grid lg:grid-cols-3 gap-6">
                {practiceAreas.map((area, index) => (
                  ...
                  >
                    ...
                    <h5 className="font-serif font-bold text-white mb-6 text-lg group-hover:text-primary transition-colors">
                      {area.title}
                    </h5>
